...
<form action="{{url('/jenis-cuti-edit-act')}}"  method="post" id="form-modal"> 
    @csrf 
    <input type="hidden" value="{{$row->id_jenis_cuti}}"  name="id">
    <input type="hidden" value="{{$row->id_perusahaan}}"  name="id_perusahaan">
    <div class="mb-3">
...
<script>
  ...
  var inputs = [
     'jenis_cuti', 'satuan_cuti', 'maksimal_cuti',  
  ] 
  ...
  $(document).ready(function(){
    ...
    $('._submit').click(function() {  
        ...
        $('span.{{$row->id_jenis_cuti}}').parentsUntil('tbody').hide('slow') // remove last tr 
        ...
        var icon_edit = '<a href="#" id="'+id+'" class="btn btn-outline-warning btn-sm jenis-cuti-edit" title="Edit Jenis Cuti"'
                                  ...
                                  +'</a>'
                        +'<a href="#" id="'+id+'" class="btn btn-outline-danger btn-sm jenis-cuti-del" title="Hapus Jenis Cuti"'
                                  +'data-bs-toggle="modal" data-bs-target="#staticBackdrop">'
