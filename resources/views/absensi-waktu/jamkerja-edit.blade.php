...
<div class="card">
    <div class="card-body">  
        ...
        <div class="row">
                ...
                <div class="p-3"> 
                    <h5>Edit Jam Kerja</h5>
                    <hr>
                </div>  

            <div class="col-sm-6"> 
                <form action="{{url('jamkerja-edit-act')}}" method="POST" id="form">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select name="shift" id="" class="form-control">
                            ...
                            @foreach($shift as $v)
                                <option value="{{$v}}" @selected($data['shift'] == $v )>{{$v}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="masuk" placeholder="" class="form-control" value="{{$data['masuk']}}"  />
                        <div class="text text-danger masuk"></div>
                    </div>  
                    <div class="mb-3">
                        <label for=""  >Jam Pulang</label>
                        <input name="pulang" type="time" placeholder="" class="form-control" value="{{$data['pulang']}}"  />
