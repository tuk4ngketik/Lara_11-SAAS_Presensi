...
<div class="card">
    <div class="card-body">  
        <div class="row">
            ...
            <div class="col-sm-5"> 
                <form action="{{url('lokasi-edit-act')}}" method="POST" id="form">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input id="latitude" name="latitude" class="form-control" value="{{$data['lat']}}" />
                        <div class="text text-danger latitude"></div>
                    </div> 
 
                    <div class="mb-3">
                        <label for=""  >Longitude</label>
                        <input id="longitude" name="longitude"  class="form-control" value="{{$data['lgt']}}"  />
                    ...
                    <div class="mb-3">
                        ...
                        <textarea  class="form-control"  name="deskripsi_lokasi">{{$data['deskripsi_lokasi']}}</textarea>
