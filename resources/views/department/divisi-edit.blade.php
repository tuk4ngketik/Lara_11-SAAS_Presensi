    ...
    <div class="card-body"> 
        ...
        <div class="row">
            ...
            <div class="col-sm-6"> 
                ...
                <form action="{{url('divisi-edit-act')}}" method="POST" id="form">
                    @csrf  
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{$data['nama_divisi']}} " class="form-control" id=""  name="nama_divisi" placeholder="Nama Divisi"> 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea  class="form-control"  name="deskripsi_divisi"> {{$data['deskripsi_divisi']}} </textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <a href="{{url('divisi')}}" class="btn btn-outline-info">Batal</a>
                    </div> 
                </form>
